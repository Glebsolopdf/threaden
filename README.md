...
включая готовые аудиофайлы и голосовые записи из браузера длительностью до пяти
минут. Обработанные фото и видео ограничены 1 МБ, аудио и прочие медиа проходят
текущий входной лимит, архивы — 5 МБ, активная квота пользователя — 50 МБ. Для
аккаунтов младше 24 часов действует временная квота 20 МБ и суточный лимит 20
МБ; после первых суток суточного лимита нет. Все вложения, включая аудио,
автоматически удаляются через 72 часа.
